...
function AdminPortal({ section }: { section: AdminSection }) {
  ...
  if (section === "accounts") return <div className="portal-stack"><AccountingStatements /><ReconciliationWorkspace /><PricingGovernanceCenter admin /><AdminOperationsCenter mode="accounts" /><AdminEmailOutbox /></div>;
