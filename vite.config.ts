...
import { REMINDER_PROCESSING_CRON, RESERVATION_RECOVERY_CRON, TRANSACTIONAL_EMAIL_OUTBOX_CRON, VENDOR_INVENTORY_ALERT_CRON } from "./lib/scheduled-job-config";
...
const localBindingConfig = {
  ...
  triggers: { crons: [RESERVATION_RECOVERY_CRON, REMINDER_PROCESSING_CRON, VENDOR_INVENTORY_ALERT_CRON, TRANSACTIONAL_EMAIL_OUTBOX_CRON] },
  d1_databases: d1
    ? [
        {
          binding: d1,
